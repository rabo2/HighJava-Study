...
public interface JdbcBoardDAOIF {
	/**
	...
	/**
	 * 게시글을 수정하는 메소드
	 * @param title 수정하려는 제목을 매개변수로 받는다.
	 * @param content 수정하려는 내용을 매개변수로 받는다.
	 * @param boardNo 수정하려는 게시글의 번호
	 * @return 수정 성공 여부를 반환 성공 :1 , 실패 : 0
	 */
